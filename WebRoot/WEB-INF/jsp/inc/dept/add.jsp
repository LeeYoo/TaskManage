...
<body>
	<div class="form-wrapper">
		...
		<form name="form" action="/user/dept_add" method="post" onsubmit="return checkForm(this)">
			<div class="form">
				<div class="form-item">
					<input type="text" name="deptname" required placeholder="部门名称" autocomplete="off"/>
				</div>
