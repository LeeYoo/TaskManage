...
<body>
	<div class="right_head_out">
		<div class="right_head_in">
	  			...
	  			<font color="pink" size="5">【用户列表】:</font>
		</div>
	<s:form action="/user/privilegeGrouplist" method="post">
		<s:hidden name="page" /> 
		<div class="right_list">
			<!-- right_list.jsp -->
			<jsp:include flush="true" page="/WEB-INF/jsp/inc/user/right_list.jsp"></jsp:include>
		</div>
