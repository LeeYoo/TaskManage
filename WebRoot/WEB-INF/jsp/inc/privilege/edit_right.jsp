...
<body>
	<div class="right_head_out">
		<div class="right_head_in">
	  			...
	  			<font color="pink" size="5">【修改权限组】:</font>
		</div>
	<s:form action="/user/privilegeGroup_edit" method="post">
		<s:hidden name="page" /> 
		<s:hidden name="groupId" /> 
		<div class="right_list">
			<!-- right_list.jsp -->
			<jsp:include flush="true" page="/WEB-INF/jsp/inc/privilege/edit.jsp"></jsp:include>
		</div>
	</s:form>
	</div>
