...
<body>
	<div class="right_head_out">
		<div class="right_head_in">
	  			...
	  			<font color="pink" size="5">【添加权限组】:</font>
		</div>
	<s:form action="/user/privilegeGroup_add" method="post">
		<s:hidden name="page" /> 
		<div class="right_list">
			<!-- right_list.jsp -->
			<jsp:include flush="true" page="/WEB-INF/jsp/inc/privilege/add.jsp"></jsp:include>
		</div>
	</s:form>
	</div>
